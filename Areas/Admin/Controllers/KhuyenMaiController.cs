        ...
        public ActionResult DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (khuyenMai != null)
                {
                    ...
                    var links = data.SanPham_KhuyenMais.Where(spkm => spkm.MaKM == id);
                    data.SanPham_KhuyenMais.DeleteAllOnSubmit(links);
